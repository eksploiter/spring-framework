...
<body>
	...
	<div class="container">
		<div class="row mt-3">
			<h2 class="bg-primary text-light text-center">상품 상세 정보</h2>
		</div>
	<form method="post">
        <table class="table">
            <tbody>
                <tr>
                    <th><label for="name">상품 번호</label></th>
                ...
                <tr>
                    ...
                    value="${product.stockQuantity}"/></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="2">                 
                        <input type="submit" value="수정" 
                        	formaction="${root}/main?action=product_modify"/>
                        <input type="submit" value="삭제" 
                        	formaction="${root}/main?action=product_delete"/>
